...
$(function() {
   ...
   ========================================================================== */
    ...
    $('#contact-form').validate({
        ...
        messages: {
            name: "<i class='fa fa-exclamation-triangle'></i>Por favor informe seu nome.",
            email: {
                required: "<i class='fa fa-exclamation-triangle'></i>Precisamos de seu endereco de e-mail para contacta-lo.",
                email: "<i class='fa fa-exclamation-triangle'></i>Por favor insira um endereco de e-mail valido."
            },
            message: "<i class='fa fa-exclamation-triangle'></i>Por favor informe uma mensagem."
        },
